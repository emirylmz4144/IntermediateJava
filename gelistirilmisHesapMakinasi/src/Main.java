    ...
    public static void main(String[] args)
    {
        ...
        do {
            ...
            switch (select)
            {
                ...
                {
                    System.out.println("********************************************");
                    System.out.println("Sonucunuz: " + plus());
                    System.out.println("********************************************");
                }
                case 2 ->
                {
                    System.out.println("********************************************");
                    System.out.println("Sonucunuz: " + minus());
                    System.out.println("********************************************");
                }
                case 3 ->
                {
                    System.out.println("********************************************");
                    System.out.println("Sonucunuz: " + times());
                    System.out.println("********************************************");
                }
                case 4 ->
                {
                    System.out.println("********************************************");
                    System.out.println("Sonucunuz: " + divided());
                    System.out.println("********************************************");
                }
                case 5 ->
                {
                    System.out.println("********************************************");
                    System.out.println("Sonucunuz: " + power());
                    System.out.println("********************************************");
                }
                case 6 ->
                {
                    System.out.println("********************************************");
                    System.out.println("Sonucunuz: " + square());
                    System.out.println("********************************************");
                }
                case 7 ->
                {
                    System.out.println("********************************************");
                    System.out.println("Sonucunuz: " + factorial());
                    System.out.println("********************************************");
                }
                case 0 ->
                {
